...
class SAPConcurExpensesheetExpenseReportMapping(Base):
    ...
    maconomy_employee_number: Mapped[str | None] = mapped_column(Text, nullable=True)
    expense_line_metadata: Mapped[dict | None] = mapped_column(JSONB, nullable=True, default=dict)
